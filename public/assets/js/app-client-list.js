  ...
  if (dt_user_table) {
    const dt_user = new DataTable(dt_user_table, {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              '<span class="badge" text-capitalized>' +
              status +
              '</span>'
            );
          }
        ...
        topEnd: {
          features: [
            ...
            },
            {
              /* buttons: [
                {
                  text: '<span class="d-flex align-items-center gap-2"><i class="icon-base ti tabler-plus icon-xs"></i> <span class="d-none d-sm-inline-block">Ajouter un client</span></span>',
                  className: 'add-new btn btn-primary',
                  action: function () {
                    window.location.href = '/systeme/clients/new';
                  }
                }
              ] */
             buttons: [
      ...
      language: {
        sLengthMenu: '_MENU_',
        search: '',
        searchPlaceholder: 'Recherche Client',
        paginate: {
