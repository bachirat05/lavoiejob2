            ...
            <div class="row row-bordered overflow-visible g-0">
              <div class="dropdown-shortcuts-item col">
                <span class="dropdown-shortcuts-icon rounded-circle mb-3">
                  <i class="icon-base ti tabler-folder-plus icon-26px text-heading"></i>
                </span>
                <a href="{{ route('dossiers.new_view') }}" class="stretched-link">Nouveau</a>
                <small>Dossier</small>
              </div>
              <div class="dropdown-shortcuts-item col">
                <span class="dropdown-shortcuts-icon rounded-circle mb-3">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
            ...
            <a class="dropdown-item mt-0" href="pages-account-settings-account.html">
              <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1">
                  ...
                  <small class="text-body-secondary">{{ ucfirst(auth()->user()->getRoleNames()->first()) }}</small>
                </div>
              </div>
            </a>
          </li>
          ...
          <li>
            <div class="d-grid px-2 pt-2 pb-1">
              <form  class="d-grid px-2 pt-2 pb-1" action="{{ route('logout') }}" method="post">
                  @csrf
