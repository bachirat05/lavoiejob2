                ...
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-xl-6 text-center text-xl-end">
                            <a href="demo-accounting-contact.html" class="btn btn-extra-large btn-yellow left-icon btn-box-shadow btn-rounded text-transform-none d-inline-block align-middle me-15px xs-m-10px"><i class="feather icon-feather-mail"></i>Free consultation</a>
            ...
            <div class="container">
                <div class="row justify-content-center fs-17 fw-300 mt-5 mb-4 md-mt-45px md-mb-45px xs-mt-35px xs-mb-35px">
                    ...
                    <div class="col-6 col-lg-3 order-sm-1 md-mb-40px xs-mb-30px last-paragraph-no-margin">
                        <a href="{{ route('home') }}" class="footer-logo mb-15px d-inline-block"><img src="images/demo-accounting-logo-white.png" data-at2x="images/demo-accounting-logo-white@2x.png" alt=""></a>
