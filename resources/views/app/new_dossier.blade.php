                ...
                <div class="bs-stepper-header border-end">
                  <div class="step" data-target="#personal-details">
                    <button type="button" class="step-trigger">
                      <span class="bs-stepper-circle"><i class="icon-base ti tabler-user-shield icon-md"></i></span>
                      <span class="bs-stepper-label">
                        <span class="bs-stepper-title">Choix du Client</span>
                        <span class="bs-stepper-subtitle">Infos clés</span>
                      </span>
                    </button>
                  </div>
                  <div class="line"></div>
                  ...
                  <div class="step" data-target="#property-area">
                    <button type="button" class="step-trigger">
                      <span class="bs-stepper-circle"><i class="icon-base ti tabler-color-swatch icon-md"></i></span>
                      <span class="bs-stepper-label">
                        <span class="bs-stepper-title">Projet et statut</span>
                        <span class="bs-stepper-subtitle">Intégration du client</span>
                      </span>
                    </button>
                  </div>
                  <div class="line"></div>
                  <div class="step" data-target="#price-details">
                    <button type="button" class="step-trigger">
                      <span class="bs-stepper-circle"><i class="icon-base ti tabler-user-star icon-md"></i></span>
                      <span class="bs-stepper-label">
                        <span class="bs-stepper-title">Evaluation et notes</span>
                        <span class="bs-stepper-subtitle">Evaluation du client</span>
                      </span>
                    </button>
                  </div>
                </div>
                <div class="bs-stepper-content">
                  <form id="wizard-property-listing-form"  action="{{ route('clients.new') }}" class="hundle-form" method="post" enctype="multipart/form-data">
                    @csrf
                    <!-- Personal Details -->
                    <div id="personal-details" class="content">
                      <div class="row g-6">
                        <div class="col-sm-12 form-control-validation">
                          <label class="form-label" for="avatarurlProjet">Image du client</label>
                          <input
                              type="file"
                              id="avatarurlProjet"
                              class="form-control"
                        ...
                        <div class="col-sm-6 form-control-validation">
                          <label class="form-label" for="plFirstName">Nom complet</label>
                          <input
                            type="text"
                            id="plFirstName"
                            name="name"
                        ...
                        <div class="col-sm-6 form-control-validation">
                          <label class="form-label" for="plEmail">Adresse Email</label>
                          <input
                            type="text"
                            id="plEmail"
                            name="email"
                            class="form-control"
                            placeholder="ahmed.doe@example.com" required />
                        </div>
                        <div class="col-md-12 form-control-validation">
                          <div class="form-check my-2 ms-2">
                            ...
                            <label class="form-check-label" for="email_verified"
                              >Je suis sûr que l'adresse email fourni est valide.</label
                            >
                          </div>
                          <div class="form-check my-2 ms-2">
                            <input class="form-check-input" type="checkbox" name="send_welcome" id="send_welcome" />
                            <label class="form-check-label" for="send_welcome"
                              >Envoyer un email de bienvenue avec les coordonnées de connexion.</label
                            >
                          </div>
                        </div>
                    ...
                    <div id="property-area" class="content">
                      ...
                      <div class="col-sm-6 form-control-validation">
                          <p class="mb-3">Statut du client</p>
                          <div class="form-check my-2 ms-2">
                            <input
                              class="form-check-input"
                              type="radio"
                              name="status"
                              id="plCommonAreaRadioYe"
                              value="prospect"
                              checked />
                            <label class="form-check-label" for="plCommonAreaRadioYe">Prospect</label>
                          </div>
                          <div class="form-check my-2 ms-2">
                            <input
                              class="form-check-input"
                              ...
                              value="valide" />
                            <label class="form-check-label" for="plCommonAreaRadioYes">Valide</label>
                          </div>
                          <div class="form-check my-2 ms-2">
                            <input
                              class="form-check-input"
                              ...
                              name="status"
                              value="disponible"
                              id="plCommonAreaRadiodisponible" />
                            <label class="form-check-label" for="plCommonAreaRadiodisponible">Disponible</label>
                          </div>
                          <div class="form-check my-2 ms-2">
                            <input
                              class="form-check-input"
                              ...
                              name="status"
                              value="indisponible"
                              id="plCommonAreaRadioindisponible" />
                            <label class="form-check-label" for="plCommonAreaRadioindisponible">Indisponible</label>
                          </div>
                          <div class="form-check my-2 ms-2">
                            <input
                              class="form-check-input"
                              ...
                              name="status"
                              value="injoignable"
                              id="plCommonAreaRadioNoinjoignable" />
                            <label class="form-check-label" for="plCommonAreaRadioNoinjoignable">Injoignable</label>
                          </div>
                          <div class="form-check my-2 ms-2">
                            <input
                              class="form-check-input"
                              ...
                              name="status"
                              value="en_attente"
                              id="plCommonAreaRadioen_attente" />
                            <label class="form-check-label" for="plCommonAreaRadioen_attente">En attente</label>
                          </div>
                          <div class="form-check my-2 ms-2">
                            <input
                              class="form-check-input"
                              ...
                              id="plCommonAreaRadioNoen_cours_de_traitement" />
                            <label class="form-check-label" for="plCommonAreaRadioNoen_cours_de_traitement">En cours de traitement</label>
                          </div>
                          <div class="form-check my-2 ms-2">
                            <input
                              class="form-check-input"
                              ...
                              name="status"
                              value="black_liste"
                              id="plCommonAreaRadioNoblack_liste" />
                            <label class="form-check-label" for="plCommonAreaRadioNoblack_liste">Black liste</label>
                          </div>
                          <div class="form-check my-2 ms-2">
                            <input
                              class="form-check-input"
                              ...
                              name="status"
                              value="rejet"
                              id="plCommonAreaRadioNorejet" />
                            <label class="form-check-label" for="plCommonAreaRadioNorejet">Rejet</label>
                          </div>
                          <div class="form-check my-2 ms-2">
                            <input
                              class="form-check-input"
                              ...
                              name="status"
                              value="bloque"
                              id="plCommonAreaRadioNobloque" />
                            <label class="form-check-label" for="plCommonAreaRadioNobloque">Bloque</label>
                          </div>
                          <div class="form-check my-2 ms-2">
                            <input
                              class="form-check-input"
                              ...
                              name="status"
                              value="néant"
                              id="plCommonAreaRadioNon" />
                            <label class="form-check-label" for="plCommonAreaRadioNon">Néant</label>
                          </div>
                        </div>
                        <div class="col-sm-6 form-control-validation">
                                ...
                                <ul class="p-0 m-0">
                                    ...
                                    <li class="d-flex align-items-start mb-4">
                                        <div class="badge bg-label-success p-2 me-3 rounded">
                                            @if ($projet->avatar_url != null)
                                            <img src="{{ asset('storage/'.$projet->avatar_url) }}" width="40px" alt="">
                                            @endif
                                        </div>
                                        <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                            <div class="me-2">
                                            <label class="mb-1" for="inputpro{{ $projet->id }}">{{ $projet->name }}</label>
                                            <small class="text-truncate">{{ $projet->description }}</small>
                                            </div>
                                            <div class="d-flex align-items-center">
                                            <div class="form-check form-check-inline">
                                                <input name="projets[]" class="form-check-input" type="checkbox" value="{{ $projet->id }}" id="inputpro{{ $projet->id }}" />
                                            </div>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <div id="price-details" class="content">
                      ...
                      <div class="col-sm-12 form-control-validation">
                          <label class="form-label" for="rate">Evaluation du client</label>
                          <div class="form-text my-4">Évaluez le comportement du client lors des échanges : courtoisie, respect des délais, qualité de la communication.<br><b>Une note élevée indique un client idéal.</b></div>
                          <div class="my-4" id="rate"></div>
                        </div>
                        ...
                        <div class="col-sm-12 form-control-validation">
                          ...
                          <textarea
                            ...
                            class="form-control"
                            rows="6"
                            placeholder="Ajouter des remarques sur le client"></textarea>
                        </div>
