    ...
    <div class="bs-stepper-header border-end">
      <div class="step" data-target="#personal-details">
        <button type="button" class="step-trigger">
          <span class="bs-stepper-circle"><i class="icon-base ti tabler-building icon-md"></i></span>
          <span class="bs-stepper-label">
            <span class="bs-stepper-title">Compte Entreprise</span>
      ...
      <div class="step" data-target="#price-details">
        <button type="button" class="step-trigger">
          ...
          <span class="bs-stepper-label">
            ...
            <span class="bs-stepper-subtitle">Evaluation de l'entreprise</span>
          </span>
        </button>
      </div>
    </div>
    <div class="bs-stepper-content">
      <form id="wizard-property-listing-form"  action="{{ route('client.new_entreprise') }}" class="hundle-form" method="post" enctype="multipart/form-data">
        @csrf
        <!-- Personal Details -->
        <div id="personal-details" class="content">
          <div class="row g-6">
            <div class="col-sm-12 form-control-validation">
              <label class="form-label" for="avatarurlProjet">Logo de l'entreprise</label>
              <input
                  type="file"
                  id="avatarurlProjet"
                  class="form-control"
            ...
            <div class="col-sm-6 form-control-validation">
              <label class="form-label" for="plFirstName">Nom de l'entreprise</label>
              <input
                type="text"
                id="plFirstName"
                name="name"
                class="form-control"
                placeholder="La Voie Job" required />
            </div>
            <div class="col-sm-6 form-control-validation">
              <label class="form-label" for="plEmail">Adresse Email de l'entreprise</label>
              <input
                type="text"
                id="plEmail"
                name="email"
