<x-app-layout>
  <div id="wizard-property-listing" class="bs-stepper vertical mt-2">
    <div class="bs-stepper-content">
      <form id="wizard-property-listing-form"  action="{{ route('demande_lallalghalia.store') }}" class="hundle-form" method="post" enctype="multipart/form-data">
        @csrf
        <div class="line"></div>
        <div class="step" data-target="#property-details">
          <button type="button" class="step-trigger">
            ...
            <span class="bs-stepper-label">
              <span class="bs-stepper-title">demande d'emploi </span>
            </span>
          </button>
        </div>
